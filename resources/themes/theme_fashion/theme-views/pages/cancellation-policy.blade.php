...
<main class="main-content d-flex flex-column gap-3 pb-3">
    <div class="page_title_overlay py-5">
        <img loading="lazy" src="{{ $page_title_banner ? asset('storage/app/public/banner/'.json_decode($page_title_banner['value'])->image) : ''}}" class="bg--img" alt="cancellation-policy" onerror="this.src='{{ theme_asset('assets/img/page-title-bg.png') }}'">
