    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header px-sm-5 pb-1">
                <h5 class="text-capitalize" id="contact_sellerModalLabel">{{translate('contact_with_seller')}}</h5>
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <div class="d-flex">
                            <button class="btn btn-base text-white me-2"
                                {{($shop_id == 0?'disabled':'')}}>{{translate('send')}}</button>
                            <button type="button" class="btn btn-reset me-2"
                                data-bs-dismiss="modal">{{translate('close')}}</button>
                        </div>
                        <div>
                            @if ($shop_id != 0)
                            <a href="{{route('chat', ['type' => 'seller','shop_id'=>$shop_id])}}"
